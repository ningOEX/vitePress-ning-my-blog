...
<template>
  <div
    class="rounded-sm text-sm grid gap-4 overflow-hidden py-6 pt-4 box-border"
  >
    <div
    ...
    >
      ...
      <span
        class="text-sm text-ellipsis line-clamp-2 w-full leading-6 text-slate-400"
        >{{ item.describe }}</span
      >
